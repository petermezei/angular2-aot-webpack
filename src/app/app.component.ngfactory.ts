...
import * as import9 from '@angular/router/src/directives/router_outlet';
import * as import10 from './common/footer/footer.component';
import * as import11 from '@angular/core/src/linker/view_container';
import * as import12 from '../../node_modules/@angular/router/src/directives/router_outlet.ngfactory';
import * as import13 from './common/footer/footer.component.ngfactory';
...
class View_AppComponent_Host0 extends import1.DebugAppView<any> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer,'pm-app',import4.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
...
export const AppComponentNgFactory:import8.ComponentFactory<import0.AppComponent> = new import8.ComponentFactory<import0.AppComponent>('pm-app',View_AppComponent_Host0,import0.AppComponent);
const styles_AppComponent:any[] = ([] as any[]);
const nodeDebugInfos_AppComponent0:import2.StaticNodeDebugInfo[] = [
  new import2.StaticNodeDebugInfo([import9.RouterOutlet],(null as any),{}),
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import2.StaticNodeDebugInfo([import10.FooterComponent],import10.FooterComponent,{})
]
;
var renderType_AppComponent:import3.RenderComponentType = import4.createRenderComponentType('/home/peter/Desktop/git/angular2-aot-webpack/src/app/app.component.ts class AppComponent - inline template',0,import5.ViewEncapsulation.None,styles_AppComponent,{});
export class View_AppComponent0 extends import1.DebugAppView<import0.AppComponent> {
  ...
  _text_1:any;
  _el_2:any;
  compView_2:import1.AppView<import10.FooterComponent>;
  _FooterComponent_2_3:import13.Wrapper_FooterComponent;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._RouterOutlet_0_5 = new import12.Wrapper_RouterOutlet(this.parentView.injectorGet(import14.RouterOutletMap,this.parentIndex),this._vc_0.vcRef,this.parentView.injectorGet(import15.ComponentFactoryResolver,this.parentIndex),(null as any));
    this._text_1 = this.renderer.createText(parentRenderNode,'\n    ',this.debug(1,0,31));
    this._el_2 = import4.createRenderElement(this.renderer,parentRenderNode,'pm-footer',import4.EMPTY_INLINE_ARRAY,this.debug(2,1,4));
    this.compView_2 = new import13.View_FooterComponent0(this.viewUtils,this,2,this._el_2);
    this._FooterComponent_2_3 = new import13.Wrapper_FooterComponent();
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import9.RouterOutlet) && (0 === requestNodeIndex))) { return this._RouterOutlet_0_5.context; }
    if (((token === import10.FooterComponent) && (2 === requestNodeIndex))) { return this._FooterComponent_2_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
